...
class CountryCode
{
     ...
     * is treated as "no custom flag" and returned as null.
     *
     * Used both when persisting the `customFlagCountry` preference and when
     * reading it back for serialization, so an invalid stored value can never
